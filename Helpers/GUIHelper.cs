...
namespace DragonVault.Helpers
{
	...
	{
		/// <summary>
		/// Draws a simple box in the style of the DragonVault GUI.
		/// </summary>
		...
		/// <summary>
		/// Draws a fancy box in the style of the DragonVault GUI.
		/// </summary>
		/// <param name="sb">the spriteBatch to draw the box with</param>
		/// <param name="target">where/how big the box should be drawn</param>
		/// <param name="color"><the color of the box/param>
		...
		/// <summary>
		/// Draws the outline of a box in the style of the DragonVault GUI.
		/// </summary>
		...
		/// <summary>
		/// Gets the inverse of a color. Used for 'constrasting' elements of the DragonVault GUI, such as outlines indicating something being on.
		/// </summary>
		...
		public static void OpenConfig(ModConfig config)
		{
			...
			setMod.Invoke(ui, new object[] { ModContent.GetInstance<DragonVault>(), config });
