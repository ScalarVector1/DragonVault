...
namespace DragonVault.Content.Themes.BoxProviders
{
	internal class VanillaBoxes : ThemeBoxProvider
	{
		...
		{
			Texture2D tex = ModContent.Request<Texture2D>("DragonVault/Assets/Themes/BoxProviders/VanillaBoxes/Box").Value;
